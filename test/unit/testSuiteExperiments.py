...
class testSuiteExperiments(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data = read_csv('test/resource/input/data.csv')
        self.annotated_train_data = pickle.load(open('test/resource/input/data_annotated.obj', 'rb'))
    ...
    '''
    # Test 04 - Validate generate_file_path
    def test_learn_classifier(self):
        print('\n\n\n\n')
        print(type(self.experiment.learn_classifier(self.experiment.learners[0], self.annotated_train_data, self.experiment.fixed_random_seed)) )
    '''
